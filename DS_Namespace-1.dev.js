                ...
                item: {
                    add: function(jsonItemData, sList, afterFx) {
                        ...
                        ds.$.ajax({
                            ...
                            if (typeof(afterFx) === "function") {
                                try { afterFx(data, textStatus, jqXHR); } catch (err) { ds.util.log("ds.rest.list.item.add method could not call afterFx and pass data, textStatus, jqXHR parameters", true);
                                    afterFx(); }
                            }
                            ds.intvls[intvl].bDone = true;
                        });
                    ...
                    delete: function(nID, sList, afterFx) {
                        ...
                        ds.$.ajax({
                            ...
                            ds.rest.lastCall.jqXHR = jqXHR;
                            if (typeof(afterFx) === "function") {
                                try { afterFx(data, textStatus, jqXHR); } catch (err) { ds.util.log("ds.rest.list.item.delete method could not call afterFx and pass data, textStatus, jqXHR parameters", true);
                                    afterFx(); }
                            }
                            ds.intvls[intvl].bDone = true;
                        });
                    ...
                    update: function(jsonItemData, sList, nID, afterFx) {
                        ...
                        ds.$.ajax({
                            ...
                            if (typeof(afterFx) === "function") {
                                try { afterFx(data, textStatus, jqXHR); } catch (err) { ds.util.log("ds.rest.list.item.update method could not call afterFx and pass data, textStatus, jqXHR parameters", true);
                                    afterFx(); }
                            }
                            ds.intvls[intvl].bDone = true;
                        });
            ...
            getBrowserNameAndVersion: function(afterFx) {
                ...
                if (navigator.userAgent.indexOf("Edge") >= 0) {
                    ...
                    if (ds.stor.session.browserVersion < 7 || ds.stor.session.browserVersion > 10) {
                        ...
                        try { var ActiveXobj = new ActiveXObject('ListNet.ListNet');
                            bActiveX = true; } catch (err) {}
                        if (bActiveX === true) {
        ...
        controls: {
            ...
            psudoPopup: {
                ...
                init: function(sListNameOrFormURL, bDoNotLoadListForm, afterFx) {
                    if (typeof(bDoNotLoadListForm) === "undefined") { var bDoNotLoadListForm = false;
                        sListNameOrFormURL = "Tasks"; }
                ...
                sizeToFitY: function() {
                    ...
                    ds.intvls.wfNoScrollY.loopingFx = function() {
                        ...
                        if (ds.controls.psudoPopup.locpos.newheight >= 800) { ds.controls.psudoPopup.locpos.newheight = 800;
                ...
                addSupportAsNeeded: function() {
                    try {
                        if (window.CSS.supports('--fake-var', 0) === true) {
                            ...
                            ds.$.ajax({
                                url: ds.p.scRoot + "Style%20Library/styles/DS_styles_with_variables.dev.css",
                                dataType: "text",
                                headers: {
                            ...
                            ds.$.ajax({
                                url: ds.p.scRoot + "Style%20Library/styles/DS_styles_variables.css",
                                dataType: "text",
                                headers: {
                                    "content-type": "text/css",
                                    "accept": "text/css"
